...
* **Model ethical agents**
  ...
  * **Utilitarianism** (minimizing total harm)
  * **Deontology** (rule-based decision-making)
  * Other possible frameworks, such as **egoism** or **fairness-based reasoning**
...
<img src="src/Simulation_idea.png" width = 90%>

* A **software prototype** of the simulation system, likely implemented in Python using an agent-based framework.
* A set of agents:
  * **symbolic ethical agents** with clearly defined decision policies.
  * **LLM-based agents** guided by different ethical prompts or reasoning styles.
* An **experimental evaluation module** to run multiple simulations and collect results
* A **final report** describing:

  * design and architectural choices
  * modeling of ethical frameworks
  * integration of LLMs into the simulation loop
