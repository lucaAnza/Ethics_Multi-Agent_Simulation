...
The experimental evaluation is designed to analyse both the internal
consistency of each ethical framework and the differences that emerge
when different ethical theories are applied to the same scenarios.

To ensure a fair comparison, paired experiments use the same scenarios,
initial conditions and random seeds whenever possible. 
